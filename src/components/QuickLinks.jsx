...
const QuickLinks = () => {
  return (
    <div className="flex flex-row space-x-8 font-inter items-center justify-start mt-6 md:-mt-20">
      <div
        onClick={() => {
          window.open(
            "https://noteslide-pdf.s3.amazonaws.com/uploads/66a567b89ab16f6aeee038f8_8a1acf87a4.pdf"
          );
        }}
